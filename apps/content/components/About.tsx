...
import { USE_CASE_TABS, TOOLS } from '@velobits/tools-registry';
import { WEB_APP_BASE_URL } from '@velobits/api-client';

const EDITOR_URL = WEB_APP_BASE_URL;
  ...
  return (
    <div className="about-page">
      ...
      <nav className="about-nav">
        <a href={EDITOR_URL} className="about-back">
          <svg
            width="14"
            height="14"
            viewBox="0 0 24 24"
        ...
        <div className="about-container about-hero-inner">
          <motion.div className="about-hero-left" {...fadeLeft()}>
            ...
            <div className="about-hero-actions">
              <a href={EDITOR_URL} className="about-cta-btn about-cta-btn--primary">
                <svg
                  width="16"
                  height="16"
                  viewBox="0 0 24 24"
