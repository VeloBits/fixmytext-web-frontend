...
import type { AlertAction, AlertLevel, ShowAlertOptions } from '@velobits/app-core/types/alert';
...
export interface AlertContextValue {
   ...
   */
  showAlert: (message: unknown, type?: AlertLevel, options?: ShowAlertOptions) => number;
