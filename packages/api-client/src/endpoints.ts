...
export const ENDPOINTS = {
  ...
  ACTIVE_VOICE: '/api/v1/ai/active-voice',
  REDUNDANCY_REMOVER: '/api/v1/ai/redundancy-remover',
  SENTENCE_SPLITTER: '/api/v1/ai/sentence-splitter',
  CONCISENESS: '/api/v1/ai/conciseness',
  RESUME_BULLETS: '/api/v1/ai/resume-bullets',
  MEETING_NOTES: '/api/v1/ai/meeting-notes',
  COVER_LETTER: '/api/v1/ai/cover-letter',
  OUTLINE_TO_DRAFT: '/api/v1/ai/outline-to-draft',
  CONTINUE_WRITING: '/api/v1/ai/continue-writing',
  ...
  YOUTUBE_DESC: '/api/v1/ai/youtube-description',
  SOCIAL_BIO: '/api/v1/ai/social-bio',
  PRODUCT_DESC: '/api/v1/ai/product-description',
  CTA_GENERATOR: '/api/v1/ai/cta-generator',
  AD_COPY: '/api/v1/ai/ad-copy',
  LANDING_HEADLINE: '/api/v1/ai/landing-headline',
  EMAIL_SUBJECT: '/api/v1/ai/email-subject',
  CONTENT_IDEAS: '/api/v1/ai/content-ideas',
  HOOK_GENERATOR: '/api/v1/ai/hook-generator',
  ...
  SYNONYM_FINDER: '/api/v1/ai/synonym-finder',
  ANTONYM_FINDER: '/api/v1/ai/antonym-finder',
  DEFINE_WORDS: '/api/v1/ai/define-words',
  WORD_POWER: '/api/v1/ai/word-power',
  VOCAB_COMPLEXITY: '/api/v1/ai/vocab-complexity',
  JARGON_SIMPLIFIER: '/api/v1/ai/jargon-simplifier',
  ...
  GENERATE_BLOG_OUTLINE: '/api/v1/ai/generate-blog-outline',
  SHORTEN_FOR_TWEET: '/api/v1/ai/shorten-for-tweet',
  REWRITE_EMAIL: '/api/v1/ai/rewrite-email',
  EXTRACT_KEYWORDS: '/api/v1/ai/extract-keywords',
  TRANSLATE: '/api/v1/ai/translate',
  TRANSLITERATE: '/api/v1/ai/transliterate',
  EMOJIFY: '/api/v1/ai/emojify',
  DETECT_LANGUAGE: '/api/v1/ai/detect-language',
  SUMMARIZE: '/api/v1/ai/summarize',
  FIX_GRAMMAR: '/api/v1/ai/fix-grammar',
  PARAPHRASE: '/api/v1/ai/paraphrase',
  CHANGE_TONE: '/api/v1/ai/change-tone',
  ANALYZE_SENTIMENT: '/api/v1/ai/analyze-sentiment',
  LENGTHEN_TEXT: '/api/v1/ai/lengthen-text',
  ELI5: '/api/v1/ai/eli5',
  PROOFREAD: '/api/v1/ai/proofread',
  GENERATE_TITLE: '/api/v1/ai/generate-title',
  REFACTOR_PROMPT: '/api/v1/ai/refactor-prompt',
  CHANGE_FORMAT: '/api/v1/ai/change-format',
} as const;
