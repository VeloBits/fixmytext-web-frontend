 ...
 */
export function NumIcon({ n, size = 24 }: NumIconProps) {
  return (
...
/** Water droplet icon. */
export function DropletIcon(p: IProps) {
  return <I {...p} d="M12 2.69l5.66 5.66a8 8 0 1 1-11.31 0L12 2.69z" />;
}

/** Sun icon with rays. */
export function SunIcon(p: IProps) {
  return (
    <I {...p}>
...
/** Running person icon. */
export function RunnerIcon(p: IProps) {
  return (
    <I {...p}>
...
/** Calendar icon. */
export function CalendarIcon(p: IProps) {
  return (
    <I {...p}>
...
/** Trophy icon. */
export function TrophyIcon(p: IProps) {
  return (
    <I {...p}>
...
/** Wrench icon. */
export function WrenchIcon(p: IProps) {
  return (
    <I
      {...p}
...
/** "2x" badge icon. */
export function TwoIcon(p: IProps) {
  return (
    <I {...p}>
      <rect
        x="2"
...
/** Star icon. */
export function StarIcon(p: IProps) {
  return (
    <I
      {...p}
...
/** Flag icon. */
export function FlagIcon(p: IProps) {
  return (
    <I {...p}>
...
/** Clipboard icon. */
export function ClipboardIcon(p: IProps) {
  return (
    <I {...p}>
...
/** Ruler / triangle icon. */
export function RulerIcon(p: IProps) {
  return (
    <I {...p}>
...
/** Leaf icon. */
export function LeafIcon(p: IProps) {
  return (
    <I {...p}>
...
/** Crown icon. */
export function CrownIcon(p: IProps) {
  return (
    <I {...p}>
...
/** Jar icon. */
export function JarIcon(p: IProps) {
  return (
    <I {...p}>
...
/** Bucket icon. */
export function BucketIcon(p: IProps) {
  return (
    <I {...p}>
...
/** Barrel icon. */
export function BarrelIcon(p: IProps) {
  return (
    <I {...p}>
...
/** Gift box icon. */
export function GiftIcon(p: IProps) {
  return (
    <I {...p}>
